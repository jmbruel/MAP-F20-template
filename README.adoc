...
- As a teacher, I want to be able to simply export the questions / answers in a format compatible with Moodle ({CSV}, {GIFT} or {AIKEN} files for example) - business priority *{must}*.
...
- We can play with several players (against each other)
